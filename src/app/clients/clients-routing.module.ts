...
const routes: Routes = [
  Route.withShell([
    {
      path: 'clients',
      data: { title: extract('labels.heading.Clients'), breadcrumb: 'Clients', routeParamBreadcrumb: false },
      children: [
        {
          path: '',
        ...
        },
        {
          path: 'create',
          data: {
            title: extract('labels.text.Create Client'),
        ...
        },
        {
          ...
          data: { title: extract('labels.text.Clients View'), routeParamBreadcrumb: 'clientId' },
          resolve: {
          ...
          children: [
            ...
            },
            {
              ...
              data: { title: extract('labels.heading.Address'), breadcrumb: 'Address', routeParamBreadcrumb: false },
              resolve: {
                clientAddressFieldConfig: ClientAddressFieldConfigurationResolver,
            ...
            },
            {
              path: 'family-members',
              data: {
                title: extract('labels.heading.Family Members'),
              ...
              children: [
                ...
                },
                {
                  ...
                  data: { title: extract('labels.text.Add'), breadcrumb: 'Add', routeParamBreadcrumb: false },
                  resolve: {
                    clientTemplate: ClientTemplateResolver,
                  },
                },
                  ...
                  children: [
                    {
                      ...
                      data: {
                        title: extract('labels.text.Family Member View'),
                        routeParamBreadcrumb: 'familyMemberId',
                      },
                      resolve: {
                        clientTemplate: ClientTemplateResolver,
            ...
            },
            {
              ...
              data: {
                title: extract('labels.heading.Identities'),
            ...
            },
            {
              ...
              data: {
                title: extract('labels.heading.Documents'),
      ...
      children: [
        {
          ...
          children: [
            {
              path: 'edit',
              data: { title: extract('labels.text.Edit Client'), breadcrumb: 'Edit', routeParamBreadcrumb: false },
            ...
            },
            {
              ...
              children: [
                {
                  path: 'overview',
                  data: { title: extract('labels.text.Charges Overview'), breadcrumb: 'Charges Overview' },
                ...
                {
                  path: ':chargeId',
                  data: { title: extract('labels.heading.Charges'), routeParamBreadcrumb: 'chargeId' },
                  children: [
                    {
                      path: '',
                    ...
                    {
                      path: 'pay',
                      data: { title: extract('labels.text.Pay Charge'), routeParamBreadcrumb: false },
