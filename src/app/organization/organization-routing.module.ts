...
const routes: Routes = [
  Route.withShell([
    {
      path: 'organization',
      data: { title: extract('labels.text.Organization'), breadcrumb: 'Organization' },
      children: [
        {
          path: '',
        ...
        },
        {
          ...
          data: { title: extract('labels.text.Provisioning Criteria'), breadcrumb: 'Provisioning Criteria' },
          children: [
            {
              path: '',
            ...
            },
            {
              path: 'create',
              data: {
                title: extract('labels.text.Create Provisioning Criteria'),
            ...
            {
              path: ':id',
              data: { title: extract('labels.text.View Provisioning Criteria'), routeParamBreadcrumb: 'id' },
              children: [
                {
                  path: '',
                ...
                },
                {
                  ...
                  data: {
                    title: extract('labels.text.Edit Provisioning Criteria'),
                    breadcrumb: 'Edit',
        ...
        {
          path: 'offices',
          data: { title: extract('labels.text.Manage Offices'), breadcrumb: 'Manage Offices' },
          children: [
            {
              path: '',
            ...
            },
            {
              ...
              data: { title: extract('labels.text.Create Office'), breadcrumb: 'Create Office' },
              resolve: {
                offices: OfficesResolver,
              },
            },
            {
              ...
              data: { title: extract('labels.commons.Combine Office'), breadcrumb: 'Combine Office' },
              resolve: {
                offices: OfficesResolver,
              },
            },
            {
              ...
              data: { title: extract('labels.commons.Split Office'), breadcrumb: 'Split Office' },
              resolve: {
                offices: OfficesResolver,
              },
            },
            {
              path: ':id',
              data: { title: extract('labels.text.View Office'), routeResolveBreadcrumb: ['office', 'name'] },
              ...
              children: [
                {
                  ...
                  data: { title: extract('labels.text.General') },
                },
                {
                  path: 'datatables',
                  children: [
                    {
                      ...
                      data: { title: extract('labels.text.View Data Table') },
                      resolve: {
            ...
            {
              path: ':id',
              data: { title: extract('labels.text.View Office'), routeParamBreadcrumb: 'id' },
              children: [
                {
                  path: 'edit',
                  component: EditOfficeComponent,
                  data: { title: extract('labels.text.Edit Office'), breadcrumb: 'Edit', routeParamBreadcrumb: false },
                  resolve: {
        ...
        },
        {
          path: 'rural-outlet',
          data: {
            title: extract('labels.commons.Manage Rural Retail Outlet'),
            breadcrumb: 'Manage Rural Retail Outlet',
          },
          children: [
            {
              path: '',
            ...
            },
            {
              ...
              data: { title: extract('labels.commons.Create Outlet'), breadcrumb: 'Create Outlet' },
              resolve: {
                offices: RetailOutletResolver,
              },
            },
            {
              path: ':id',
              data: {
                title: extract('labels.commons.Rural Outlet'),
                routeParamBreadcrumb: 'id',
                routeResolveBreadcrumb: ['offices', 'name'],
              },
            ...
            {
              path: ':id',
              data: { title: extract('labels.commons.Rural Outlet'), routeParamBreadcrumb: 'id' },
              children: [
                {
                  path: 'edit',
                  data: {
                    title: extract('labels.commons.Edit Rural Outlet'),
                    breadcrumb: 'Edit',
                    routeParamBreadcrumb: false,
                  },
        ...
        {
          path: 'employees',
          data: { title: extract('labels.text.Manage Employees'), breadcrumb: 'Manage Employees' },
          children: [
            {
              path: '',
            ...
            },
            {
              ...
              data: { title: extract('labels.text.Create Employee'), breadcrumb: 'Create Employee' },
              resolve: {
                offices: OfficesResolver,
              },
            },
            {
              path: ':id',
              data: { title: extract('labels.text.View Employee'), routeParamBreadcrumb: 'id' },
              children: [
                {
                  path: '',
                ...
                },
                {
                  ...
                  data: {
                    title: extract('labels.text.Edit Employee'),
                    breadcrumb: 'Edit',
                    routeParamBreadcrumb: false,
                  },
                  resolve: {
        ...
        {
          path: 'currencies',
          data: { title: extract('labels.text.Currency Configuration'), breadcrumb: 'Currency Configuration' },
          children: [
            {
              path: '',
            ...
            {
              path: 'manage',
              data: { title: extract('labels.text.Manage Currencies'), breadcrumb: 'Manage Currencies' },
        ...
        {
          path: 'sms-campaigns',
          data: { title: extract('labels.text.SMS Campaigns'), breadcrumb: 'SMS Campaigns' },
          children: [
            {
              path: '',
            ...
            {
              path: 'create',
              data: { title: extract('labels.text.Create SMS Campaign'), breadcrumb: 'Create Campaign' },
            ...
            },
            {
              path: ':id',
              data: {
                title: extract('labels.text.View SMS Campaign'),
                routeResolveBreadcrumb: ['smsCampaign', 'campaignName'],
              },
              resolve: {
              ...
              children: [
                ...
                },
                {
                  ...
                  data: {
                    title: extract('labels.text.Edit SMS Campaign'),
                    breadcrumb: 'Edit',
        ...
        },
        {
          ...
          data: {
            title: extract('labels.text.Standing Instructions History'),
        ...
        },
        {
          ...
          data: { title: extract('labels.text.Advance Search'), breadcrumb: 'Advance Search' },
          resolve: {
        ...
        {
          path: 'adhoc-query',
          data: { title: extract('labels.text.Adhoc Query'), breadcrumb: 'Adhoc Query' },
          children: [
            {
              path: '',
            ...
            },
            {
              ...
              data: { title: extract('labels.text.Create Adhoc Query'), breadcrumb: 'Create' },
              resolve: {
            ...
            {
              path: ':id',
              data: { title: extract('labels.text.View Adhoc Query'), routeParamBreadcrumb: 'id' },
              children: [
                {
                  path: '',
                ...
                },
                {
                  ...
                  data: {
                    title: extract('labels.text.Edit Adhoc Query'),
                    breadcrumb: 'Edit',
                    routeParamBreadcrumb: false,
                  },
                  resolve: {
        ...
        {
          path: 'tellers',
          data: { title: extract('labels.text.Tellers'), breadcrumb: 'Tellers' },
          children: [
            {
              path: '',
            ...
            },
            {
              ...
              data: { title: extract('labels.text.Create Teller'), breadcrumb: 'Create' },
              resolve: {
                offices: OfficesResolver,
              },
            },
            {
              path: ':id',
              data: { title: extract('labels.text.View Teller'), routeParamBreadcrumb: 'id' },
              children: [
                {
                  path: '',
                ...
                },
                {
                  ...
                  data: { title: extract('labels.text.Edit Teller'), breadcrumb: 'Edit', routeParamBreadcrumb: false },
                  resolve: {
                    teller: TellerResolver,
                    offices: OfficesResolver,
                  },
                },
                {
                  path: 'cashiers',
                  data: {
                    title: extract('labels.buttons.View Cashiers'),
                    breadcrumb: 'Cashiers',
                    routeParamBreadcrumb: false,
                  },
                  children: [
                    ...
                    {
                      path: 'create',
                      data: { title: extract('labels.buttons.View Cashiers'), breadcrumb: 'Create Cashier' },
                    ...
                    {
                      path: ':id',
                      data: { title: extract('labels.buttons.View Cashiers'), routeParamBreadcrumb: 'id' },
                      children: [
                        {
                          path: '',
                          component: ViewCashierComponent,
                          data: {
                            title: extract('labels.buttons.View Cashier'),
                        ...
                        },
                        {
                          ...
                          data: {
                            title: extract('labels.text.Edit Cashier'),
                            breadcrumb: 'Edit',
                            routeParamBreadcrumb: false,
                          },
                          resolve: {
                        ...
                        },
                        {
                          path: 'transactions',
                          data: {
                            title: extract('labels.text.Cashier Transactions'),
                        ...
                        },
                        {
                          ...
                          data: {
                            title: extract('labels.text.Settle Cash'),
                        ...
                        },
                        {
                          ...
                          data: {
                            title: extract('labels.text.Allocate Cash'),
        ...
        {
          path: 'payment-types',
          data: { title: extract('labels.text.Payment Types'), breadcrumb: 'Payment Types' },
          children: [
            {
              path: '',
            ...
            },
            {
              ...
              data: { title: extract('labels.text.Create Payment Type'), breadcrumb: 'Create Payment Type' },
            },
            {
              path: ':id',
              ...
              children: [
                {
                  ...
                  data: {
                    title: extract('labels.text.Edit Payment Type'),
                    breadcrumb: 'Edit',
                    routeParamBreadcrumb: false,
                  },
                  resolve: {
        ...
        },
        {
          ...
          data: { title: extract('labels.text.Password Preferences'), breadcrumb: 'Password Preferences' },
          resolve: {
        ...
        },
        {
          ...
          data: { title: extract('labels.text.Bulk Loan Reassignment'), breadcrumb: 'Bulk Loan Reasssignment' },
          resolve: {
            offices: OfficesResolver,
          },
        },
        {
          ...
          data: { title: extract('labels.text.Entity Data Table Checks'), breadcrumb: 'Entity Data Table Checks' },
          children: [
            {
              path: '',
            ...
            },
            {
              ...
              data: { title: extract('labels.text.Create Entity Data Table Checks'), breadcrumb: 'Create' },
              resolve: {
        ...
        },
        {
          ...
          data: { title: extract('labels.text.Working Days'), breadcrumb: 'Working Days' },
          resolve: {
        ...
        },
        {
          ...
          data: { title: extract('labels.text.Manage Funds'), breadcrumb: 'Manage Funds' },
          resolve: {
        ...
        {
          path: 'bulk-import',
          data: { title: extract('labels.text.Bulk Import'), breadcrumb: 'Bulk Import' },
          children: [
            {
              path: '',
            ...
            },
            {
              ...
              data: { title: extract('labels.heading.Loan Repayments'), breadcrumb: 'Repayments Download' },
              children: [
                {
                  path: '',
            ...
            },
            {
              ...
              data: { title: extract('labels.text.View Bulk Import'), routeParamBreadcrumb: 'import-name' },
              resolve: {
                countries: CountriesResolver,
        ...
        {
          path: 'holidays',
          data: { title: extract('labels.text.Manage Holidays'), breadcrumb: 'Manage Holidays' },
          children: [
            {
              path: '',
            ...
            },
            {
              ...
              data: { title: extract('labels.text.Create Holiday'), breadcrumb: 'Create' },
              resolve: {
                offices: OfficesResolver,
            ...
            {
              path: ':id',
              data: { title: extract('labels.text.View Holidays'), routeParamBreadcrumb: 'id' },
              children: [
                {
                  path: '',
                ...
                },
                {
                  ...
                  data: {
                    title: extract('labels.text.Edit Holidays'),
                    breadcrumb: 'Edit',
                    routeParamBreadcrumb: false,
                  },
                  resolve: {
        ...
        {
          path: 'audit-trails',
          data: { title: extract('labels.text.Audit Trails'), breadcrumb: 'Audit Trails' },
          children: [
            {
              path: '',
            ...
            },
            {
              ...
              data: { title: extract('labels.text.View Audit'), routeParamBreadcrumb: 'id' },
              resolve: {
