...
@Component({
  selector: 'mifosx-rejected-kyc-verification',
  templateUrl: './rejected-kyc-verification.component.html',
  styleUrls: ['./rejected-kyc-verification.component.scss']
})
export class RejectedKycVerificationComponent {
