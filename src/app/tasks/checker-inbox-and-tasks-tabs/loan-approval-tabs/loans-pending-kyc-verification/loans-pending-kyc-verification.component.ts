...
@Component({
  ...
  templateUrl: './loans-pending-kyc-verification.component.html',
  styleUrls: ['./loans-pending-kyc-verification.component.scss']
})
export class LoansPendingKycVerificationComponent {
